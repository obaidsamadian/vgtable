            ...
            >
                ...
                >
                  ...
                  <span v-if="!column.html">
                      <vgt-inline-edit @onDataChanged="onDataChanged(row.originalIndex,column.field,$event,row)" :cell-data="collectFormatted(row, column)"></vgt-inline-edit>
                  </span>
                                <span
                                        v-if="column.html"
...
<script>
    ...
    import VgtInlineEdit from './VgtInlineEdit';
    ...
    export default {
        ...
        methods: {
            ...
            onDataChanged(rowIndex, field, newData,row) {
                console.log(row);
                this.$emit('on-data-changed',rowIndex,field,newData);
                this.$emit('on-send-data-to-server',row,field,newData);
                return false;
            },
            // field can be:
            // 1. function
